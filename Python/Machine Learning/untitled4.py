...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec 16 12:38:25 2019
...
print('Ridge with Alpha 9')
print('Coefficients : ',rr9.coef_)
print('Intercept : ',rr9.intercept_)
print('Train score : ',rr9.score(X_train,y_train))
print('Test score : ',rr9.score(X_test,y_test))
print()
