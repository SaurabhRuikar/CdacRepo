...
public class MySparkYoutube6 {

public static void main(String[] args) {
		
		
		JavaSparkContext context = new JavaSparkContext("local[*]", "max");
		...
		JavaPairRDD<String,Integer> wordTuple = lines1.mapToPair(new PairFunction<String, String, Integer>() 
		{
			...
			public Tuple2<String, Integer> call(String t) throws Exception {
				...
				return new Tuple2<String, Integer>("Max views",Integer.parseInt(words[5]));
			}
		});
