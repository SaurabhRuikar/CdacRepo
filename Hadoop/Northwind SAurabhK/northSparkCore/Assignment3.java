...
public static void main(String[] args)
	...
	
	{
		...
		JavaRDD<String> lines = context.textFile("/home/student/DBDA_CHEATS/Hadoop/import-northwind-master/customers.csv");
		JavaRDD<String> lines1= lines.filter(new Function<String, Boolean>() {

			@Override
			public Boolean call(String v1) throws Exception {
				// TODO Auto-generated method stub
				return v1.contains("Brazil");
			}
		...
		JavaPairRDD<String,Integer> wordTuple = lines1.mapToPair(new PairFunction<String, String, Integer>() 
		{
			...
			public Tuple2<String, Integer> call(String t) throws Exception {
				...
				return new Tuple2<String, Integer>(words[8],1);
			}
		});
